  ...
  240 PROC_SET_SPRITE1 : REM SET PLAYER ON START UP.
  250 :
 1000 REM GAME LOOP.
 ...
 1120 IF A%=21 THEN X%=X%+2 : PROC_SET_SPRITE1 : REM SET AND MOVE SPRITE RIGHT.
 1130 IF A%=8 THEN X%=X%-2 : PROC_SET_SPRITE2 : REM SET AND MOVE SPRITE LEFT.
 1140 IF A%=10 THEN Y%=Y%+2 : PROC_SET_SPRITE1 : REM SET AND MOVE SPRITE UP.
 1150 IF A%=11 THEN Y%=Y%-2 : PROC_SET_SPRITE2 : REM SET AND MOVE SPRITE DOWN.
 1170 :
 ...
 1250 REM IF FCN%=1 THEN VDU 23,27,9 : IF FCN%=2 THEN VDU 23,27,8 : REM ANIMATION FRAMES.
 1300 GOTO 1000 : REM END GAME LOOP.
 1310 :
 1490 REM SPRITE 1 PLAYER RIGHT.
 1500 DEF PROC_SET_SPRITE1
 1520 VDU 23,27,12 : REM HIDE CURRENT SPRITE.
 1530 VDU 23,27,4,0 : REM SELECT SPRITE 0 (equating to buffer ID numbered 64000+0).
 1540 VDU 23,27,5   : REM CLEAR FRAMES FOR CURRENT SPRITE.
 1550 VDU 23,27,6,0 : REM ADD BITMAP 0 AS FRAME 2 OF SPRITE 1.
 1560 VDU 23,27,6,1 : REM ADD BITMAP 1 AS FRAME 2 OF SPRITE 1.
 1630 VDU 23,27,11  : REM SHOW THE CURRENT SPRITE 1.
 1640 VDU 23,27,7,1 : REM ACTIVATE SPRITE 1.
 1650 PROC_MOVE_SPRITE
 1680 ENDPROC : REM END PROC_SET_SPRITE_1
 1690 :
 1700 REM SPRITE 2 PLAYER LEFT.
 1710 DEF PROC_SET_SPRITE2
 1720 VDU 23,27,12 : REM HIDE CURRENT SPRITE.
 1730 VDU 23,27,4,1 : REM SELECT SPRITE 1 (equating to buffer ID numbered 64000+0).
 1740 VDU 23,27,5   : REM CLEAR FRAMES FOR CURRENT SPRITE.
 1750 VDU 23,27,6,2 : REM ADD BITMAP 2 AS FRAME 1 OF SPRITE 2.
 1760 VDU 23,27,6,3 : REM ADD BITMAP 3 AS FRAME 2 OF SPRITE 2.
 1770 VDU 23,27,11  : REM SHOW THE CURRENT SPRITE 2.
 1780 VDU 23,27,7,2 : REM ACTIVATE SPRITE 2.
 1790 PROC_MOVE_SPRITE
 1820 ENDPROC : REM END PROC_SET_SPRITE_2.
 1830 :
 1900 DEF PROC_MOVE_SPRITE
 1905 IF FCN%=1 THEN VDU 23,27,8 : IF FCN%=2 THEN VDU 23,27,9 : REM ANIMATION FRAMES.
 1910 VDU 23,27,13, X%;Y%; : REM MOVE CURRENT SPRITE TO POS X,Y.
 1920 VDU 23,27,15 : REM UPDATE THE SPRITES IN THE GPU.
 1930 :
 1950 ENDPROC
 1960 :
